...
set_property PACKAGE_PIN V16 [get_ports start_1]					
	set_property IOSTANDARD LVCMOS33 [get_ports start_1]
...
#set_property PACKAGE_PIN E19 [get_ports finish]					
#	set_property IOSTANDARD LVCMOS33 [get_ports finish]
#set_property PACKAGE_PIN U19 [get_ports {ledg[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledg[2]}]
#set_property PACKAGE_PIN V19 [get_ports {ledg[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledg[3]}]
#set_property PACKAGE_PIN W18 [get_ports {ledg[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledg[4]}]
#set_property PACKAGE_PIN U15 [get_ports {ledg[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledg[5]}]
#set_property PACKAGE_PIN U14 [get_ports {ledg[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledg[6]}]
#set_property PACKAGE_PIN V14 [get_ports {ledg[7]}]					
...
set_property PACKAGE_PIN U17 [get_ports reset_1]						
...
###Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports cs]					
#	set_property IOSTANDARD LVCMOS33 [get_ports cs]
###Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports s_data_in]					
...
set_property PACKAGE_PIN A16 [get_ports cs]					
	set_property IOSTANDARD LVCMOS33 [get_ports cs]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports s_data_in]					
	set_property IOSTANDARD LVCMOS33 [get_ports s_data_in]
##Sch name = JB4
